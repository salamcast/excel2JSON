...
It's really simple to use, you can instantiate the class with the excel file you want to read 
 - must be ooxml, normally with an xlsx or xlsm file extention
